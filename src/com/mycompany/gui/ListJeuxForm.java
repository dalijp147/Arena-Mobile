...
public class ListJeuxForm extends BaseForm{
    ...
    public ListJeuxForm(Resources res){
  ...
  swipe.setUIID("Container");
        ...
        ArrayList<Jeux>list = ServiceJeux.getInstance().AfficherJeux(); 
             int i = 0;
        for(Jeux c : list)
        {
            i++;
             String urlImage = "http://localhost/Arena/public/uploads/"+c.getImagejeux();
            System.out.println(c.getImagejeux());
    ...
    private void addJeux(Image img,Jeux c, Resources res, int i) {
